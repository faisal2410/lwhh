...
if ('delete' == $task) {
    ...
    if ($id > 0) {
        deleteStudent($id);
        header('location: /lwhh/session/myauthcrud/index.php?task=report');
    }
}
    ...
    <div class="container">
        <div class="row">
            <div class="column column-60 column-offset-20">
                <h2>MY Simple CRUD Project with user authentication</h2>
        ...
        <?php if ('add' == $task) : ?>
            <div class="row">
                <div class="column column-60 column-offset-20">
                    <form action="/lwhh/session/myauthcrud/index.php?task=add" method="POST">
